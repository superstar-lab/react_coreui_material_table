...
function createData(name, amount, fat, carbs, protein) {
  counter += 1;
  return {
    id: counter, name, amount, fat, carbs, protein,
  };
}
                    ...
                    .map((d, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="material-table__cell  material-text-align" padding="checkbox">
                            {rowsPerPage - index}
                          </TableCell>
                          <TableCell
